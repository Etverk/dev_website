...
sections.forEach(function(section) {
  ...
  button.addEventListener("click", function() {
    ...
    collapsible_paragraph.style.maxHeight = (collapsible_paragraph.style.maxHeight === "100px") ? "0px" : "100px";
    ...
    loading_bar.style.display = (paragraph.style.display === "block") ? "none" : "block";
  });
});
